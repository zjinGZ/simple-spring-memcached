...
```
The xml file is available in simple-spring-memcached-3.2.0.jar.
...
More examples are in [integration test](https://code.google.com/p/simple-spring-memcached/source/browse/#svn%2Ftags%2F3.2.0%2Fintegration-test%2Fsrc) project.
...
All classes related to integration SSM with Spring Cache (com.google.code.ssm.spring: SSMCache, SSMCacheManager) are included in spring-cache-3.2.0.jar (com.google.code.simple-spring-memcached:spring-cache). This jar is a part of SSM project, it is not a part of Spring project.
