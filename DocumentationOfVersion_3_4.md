...
```
The xml file is available in simple-spring-memcached-3.4.0.jar.
...
More examples are in [integration test](https://github.com/ragnor/simple-spring-memcached/tree/3.4.0/integration-test) project.
...
All classes related to integration SSM with Spring Cache (com.google.code.ssm.spring: SSMCache, SSMCacheManager) are included in spring-cache-3.4.0.jar (com.google.code.simple-spring-memcached:spring-cache). This jar is a part of SSM project, it is not a part of Spring project.
